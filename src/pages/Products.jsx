                        ...
                        <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl shadow-blue-900/20 transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl w-full border border-slate-200">
                            ...
                            <form onSubmit={handleSubmit} className="px-6 py-6 overflow-hidden">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    {/* Product Image URL */}
                                    <div>
                                        <label htmlFor="image" className="block text-sm font-semibold text-slate-700 mb-1">Product Image URL</label>
                                        <div className="relative">
                                            <input type="text" name="image" id="image"
                                                value={formData.image} onChange={handleInputChange}
                                                className="w-full border border-slate-300 rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
